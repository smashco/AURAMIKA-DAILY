...
abstract class HomeData {
  ...
  static const List<HomeProduct> allProducts = [
    ...
    HomeProduct(
      ...
      vibe: 'Street Wear',
      imageUrl: 'assets/images/products/e15_black_enamel.png',
    ),
  ...
  static final List<HomeProduct> weekendEdit = [
    allProducts[0], // e1 Chunky Gold Hoops
    allProducts[16], // n2 Diamond Tennis Necklace
    allProducts[30], // r1 Signet Ring
    allProducts[40], // b1 Tennis Bracelet
    allProducts[3], // e4 Vintage Coin Dangelers
  ];
}
